...
async def gen_link_batch(bot, message):
    if " " not in message.text:
        return await message.reply("Use correct format.\nExample <code>/forward {from channel first message link} {form channel last message link}")
    links = message.text.strip().split(" ")
    if len(links) != 3:
        return await message.reply("Use correct format.\nExample <code>/forward https://t.me/kcfilmss/10 https://t.me/kcfilmss/20</code>.")
